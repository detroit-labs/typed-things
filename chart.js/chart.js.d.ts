...
declare namespace Chart.Tooltip {
    let positioners: { [N in TooltipPositionerType]: (elements, eventPosition) => ChartPoint };
}
...
declare namespace Chart {
    ...
    type TooltipPositionerType = 'average' | 'nearest' | string;
    ...
    interface ChartTooltipOptions {
        ...
        position?: TooltipPositionerType;
        caretPadding?: number;
